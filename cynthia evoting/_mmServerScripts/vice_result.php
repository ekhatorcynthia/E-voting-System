...
<title>||<?php echo $_SESSION['username'];?> ||VICE PRESIDENT RESULT</title>
...
<ul>
		<li></li>
	    <div align="center"><a href="Vice_pres.php">Voting Page 
	    </a></div>
	</ul>
</div>
<div id="content">
...
<div id="footer">
  ...
  <p class="style1">UPDATED VICE PRESIDENT RESULT </p>
...
?>
      <tr>
        ...
        <td  style="<?php echo $col_val['vice_count']; ?>"><?php echo $col_val['vice_count'] ; ?> </td>
      </tr>
      <?php  } 
	  ?>
  </table>
