...
<title>|| <?php echo $_SESSION['username'];?> ||SOCIAL DIRECTOR RESULTS</title>
...
<ul>
		<li></li>
	    <div align="center"><a href="Social_director.php">Voting Page 
	    </a></div>
	</ul>
</div>
<div id="content">
    ...
    THIS E-VOTING SYSTEMIS FOR ELEGIBLE STUDENT OF AHMABU BELLO UNIVERSITY  
    </marquee>
    </strong></p>
</div>
...
<div id="footer">
  ...
  <p class="style1">UPDATED SOCIAL DIRECTOR RESULT </p>
...
?>
      <tr>
        ...
        <td  style="<?php echo $col_val['social_count']; ?>"><?php echo $col_val['social_count'] ; ?> </td>
      </tr>
      <?php  } 
	  ?>
  </table>
